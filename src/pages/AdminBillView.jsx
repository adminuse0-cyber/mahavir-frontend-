      ...
      <>
        <div className="navbar">
          <div className="navbar-left">
            <Link to="/admin_merchant_bills" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', color: 'inherit' }}>
  ...
  return (
    <>
      <div className="top-info-bar no-print">
        <ScrollingText>Admin Panel – View Merchant Invoice.</ScrollingText>
      </div>
      ...
      <div className="navbar no-print">
        ...
        <div className="navbar-right" style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <button 
            ...
            onClick={() => navigate('/admin_merchant_bills')} 
      ...
      <div className="main-container printable-area">
        ...
        <div className="no-print" style={{ textAlign: 'center', marginTop: '20px', marginBottom: '40px' }}>
          <button className="button-secondary" onClick={() => navigate('/admin_merchant_bills')} style={{ marginRight: '10px' }}>
            Back to Bills
          </button>
